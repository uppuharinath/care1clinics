       ...
       <div className="row">
        <div className="col-6">
          <form onSubmit={onSubmit} className="login-form">
            <h2>Login with existing credentials</h2>
...
<hr/>
          <div className="divider mt-1r mb-1r pl-1r text-center">
              <h2>           Click on Google icon to login with gmail account
</h2>
          </div>
        ...
        <div className="col-12 flex jcc aic m-auto text-center register-link">
          <RegisterLink />
        </div>
       </div>
